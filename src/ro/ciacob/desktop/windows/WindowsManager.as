    ...
    public function alignWindows(mobileWindowUid:String, anchorWindowUid:String,
        ...
        if (isWindowAvailable(mobileWindowUid) && isWindowVisible(anchorWindowUid)) {
            ...
            var performAlignment:Function = function ():void {
                ...
                updateWindowBounds(mobileWindowUid, alignedBounds);
            };
            ...
            ([mobileWinRecord, anchorWinRecord]).forEach(
                    function (winRecord:WindowRecord, ...etc):void {
                        ...
                        if (window.$frameCounter > 2) {
                            ...
                            var onWindowReady:Function = function (...ignore):void {
    ...
    public function alignWindowToScreen(windowUid:String, screenUid:String,
        ...
        if (allScreensInfo && isWindowAvailable(windowUid) && isWindowVisible(windowUid)) {
            var performAlignment:Function = function ():void {
                ...
                updateWindowBounds(windowUid, alignedBounds);
            }
            var winRecord:WindowRecord = _catalogue.lookup(windowUid);
            var window:Window = winRecord.window;
            if (window.$frameCounter > 2) {
                performAlignment();
            } else {
        ...
        return alignsToRequestedScreen;
    }
